...
def evaluate(X_data, y_data):
    ...
    for offset in range(0, num_examples, BATCH_SIZE):
        ...
        accuracy = sess.run(accuracy_operation, feed_dict={features_placeholder: batch_x, logits_placeholder: batch_y})
...
#        X_train, y_train = shuffle(train["features"], train["labels"])
        for offset in range(0, n_train, BATCH_SIZE):
            ...
            sess.run(training_operation, feed_dict={features_placeholder: batch_x, logits_placeholder: batch_y})
